...
- **Fixed invalid forum topic handling**: Bot now immediately clears invalid saved topic IDs (e.g., topic 1 when it doesn't exist) and auto-discovers open topics. Improved error detection for "message thread not found" errors during automated quiz delivery.
